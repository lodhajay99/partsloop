...
| **2:18–2:35** | **Reserve** → seller revealed. Then **Pay now** → show the split panel. | "Reserve, and the seller appears — Balaji Motor Parts, address, phone, held thirty minutes. Paying routes the money to the seller through Razorpay Route — and holds it there, unsettled, until the part actually changes hands. We take no cut; the plan is a flat subscription per shop, not a tax on every trade." |
